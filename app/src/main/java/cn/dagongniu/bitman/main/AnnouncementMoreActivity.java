...
import cn.dagongniu.bitman.main.adapter.AnnouncementMoreAdapter;
import cn.dagongniu.bitman.main.bean.NoticeCenterMoreBean;
import cn.dagongniu.bitman.main.presenter.NoticeCenterReadMorePresenter;
...
public class AnnouncementMoreActivity extends BaseActivity implements INoticeCenterMorelView, OnRefreshListener,
    ...
    protected void initData() {
        ...
        Logs.s("  ArticleTypeArticleType " + ArticleType);
        mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Logs.s("  ArticleTypeArticleType11 " + listBeans.get(position).getType());
