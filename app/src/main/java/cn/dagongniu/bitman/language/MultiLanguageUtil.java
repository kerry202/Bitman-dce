package cn.dagongniu.bitman.language;
...
public class MultiLanguageUtil {
    ...
    private Locale getLanguageLocale() {
        ...
        }else if (languageType == LanguageType.LANGUAGE_TY_TRADITIONAL){
            return Locale.FRANCE;  //Locale 系统没有提供泰国语言常量，使用发文实际运行的是泰文
        }
    ...
    public String getLanguageName(Context context) {
        ...
        if (languageType == LanguageType.LANGUAGE_EN) {
            ...
            return mContext.getString(R.string.setting_traditional_ty);
        }
    ...
    public int getLanguageType() {
        ...
        if (languageType == LanguageType.LANGUAGE_CHINESE_SIMPLIFIED) {
            ...
            return LanguageType.LANGUAGE_TY_TRADITIONAL;
        }
