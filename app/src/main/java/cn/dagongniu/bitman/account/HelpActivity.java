...
import cn.dagongniu.bitman.account.fragment.HelpFragment;
    ...
    private void initIndicator() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setSelectedColor(getResources().getColor(R.color.text_str));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                linePagerIndicator.setColors(getResources().getColor(R.color.text_str));
