...
import cn.dagongniu.bitman.account.bean.EarningsOverviewItemBean;
import cn.dagongniu.bitman.account.presenter.EarningsOverviewPresenter;
...
import cn.dagongniu.bitman.customview.ShadowTextView;
...
//    RecyclerView mRecyclerView;
    ...
    LinearLayout llCirculationMarketValue;
    @BindView(R.id.ll_total)
    LinearLayout llTotal;
    @BindView(R.id.ll_total_market_value)
    LinearLayout llTotalMarketValue;
    @BindView(R.id.ll_circulation_total)
    LinearLayout llCirculationTotal;
