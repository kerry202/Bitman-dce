...
import cn.dagongniu.bitman.account.presenter.UserIdentityAuthenPresenter;
...
public class IdentityAuthenticationActivity extends BaseActivity implements IView, BottomCountriesFragment.MyDialogFragment_Listener,
    ...
    public void checkLegal(String name, String number) {
        if (isFullFace && isReverseFace && !TextUtils.isEmpty(name) && !TextUtils.isEmpty(number)) {
            tvSubmit.setBackgroundResource(R.drawable.white_circle3);
            tvSubmit.setClickable(true);
            tvSubmit.setTextColor(getResources().getColor(R.color.white));
        } else {
            tvSubmit.setBackgroundResource(R.drawable.noclick_circle_gray);
            tvSubmit.setClickable(false);
            tvSubmit.setTextColor(getResources().getColor(R.color.text_str));
        }
    }
    ...
    public void choosePhotos(ImageView imageView) {
        ...
        cancle.setTextSize(getResources().getDimension(R.dimen.d18));
        ...
        promptButton.setTextSize(getResources().getDimension(R.dimen.d18));

        PromptButton promptButton1 = new PromptButton(this.getResources().getString(R.string.choose_photos), new PromptButtonListener() {
            @Override
            public void onClick(PromptButton promptButton) {
        ...
        promptButton1.setTextColor(getResources().getColor(R.color.text_str));
        promptButton1.setTextSize(getResources().getDimension(R.dimen.d18));
    ...
    public void setFullFaceContainerSuccess(String data) {
        Glide.with(IdentityAuthenticationActivity.this).load(data).into(imFullFaceContainer);
        isFullFace = true;
    ...
    public void setReverseFaceContainerSuccess(String data) {
        Glide.with(IdentityAuthenticationActivity.this).load(data).into(imReverseFaceContainer);
        isReverseFace = true;
        checkLegal(tvName.getText().toString(), tvNumber.getText().toString());
    ...
    public void isfailure(String msg) {
        ToastUtil.ShowToast(this.getResources().getString(R.string.withdrawal_failed));
