...
//                                                    //只许数字和字母
    public static final String REGEX_PASSWORD = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$";
                                                 //4选3
//    public static final String REGEX_PASSWORD = "^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\\W_]+$)(?![a-z0-9]+$)(?![a-z\\W_]+$)(?![0-9\\W_]+$)[a-zA-Z0-9\\W_]{6,16}$";
//    public static final String REGEX_PASSWORD = "^(?![A-Z]+$)(?![a-z]+$)(?!\\d+$)(?![\\W_]+$)\\S{6,16}$"; //4选2
//    public static final String REGEX_PASSWORD = "^(?=.*[0-9].*)(?=.*[a-zA-Z].*).{6,16}$";  //必须带数字和字母
