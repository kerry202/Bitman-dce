...
import cn.dagongniu.bitman.zxing.utils.CommonUtils;


/**
 * Created by yangbo on 2018/2/9
 */
...
//    private static String hintMsg;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        laserColor = resources.getColor(R.color.text_str);
//        hintMsg = resources.getString(R.string.scan_des);
        //文字
