...
import cn.dagongniu.bitman.assets.adapter.TakeRedPacketDetailsAdapter;
import cn.dagongniu.bitman.assets.bean.TakeRedPacketDetailsBean;
import cn.dagongniu.bitman.assets.presenter.TakeRedPacketDetailsPresenter;
            ...
            case R.id.rl_send_red:
                ...
                sharePopWind = new SharePopWind(this, new SharePopWind.OnShareClickListener() {
                    ...
                    public void OnShareCopy() {
                        ...
                        PageToolUtils.CopyText(OaxRedEnvelopeDetailsActivity.this, tvurl.getText().toString());
                    }
                });
