...
import cn.dagongniu.bitman.assets.adapter.TopUpRecordAdapter;
import cn.dagongniu.bitman.assets.bean.PropertyRechargeBean;
import cn.dagongniu.bitman.assets.presenter.PropertyRechargePresenter;
...
public class TopUpFragment extends BaseFragment implements IPropertyRechargeView, OnRefreshListener,
    ...
    protected void initView() {
        super.initView();
        initSmartRefresh();
        iv_load.setBackgroundResource(R.mipmap.no_topup_icon);
        tv_load.setText(getResources().getString(R.string.no_topup_str));
