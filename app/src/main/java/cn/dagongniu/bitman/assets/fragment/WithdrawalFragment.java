...
import cn.dagongniu.bitman.assets.adapter.WithdrawalRecordAdapter;
import cn.dagongniu.bitman.assets.bean.PropertyWithdrawBean;
import cn.dagongniu.bitman.assets.presenter.PropertyWithdrawPresenter;
...
public class WithdrawalFragment extends BaseFragment implements IPropertyWithdrawView, OnRefreshListener,
    ...
    protected void initView() {
        super.initView();
        initSmartRefresh();
        iv_load.setBackgroundResource(R.mipmap.no_witdraw_icon);
        tv_load.setText(getResources().getString(R.string.no_withdrawal_str));
    ...
    private void sortingImg() {
        if (iRltime == 0) {
            imSortingTime.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_s));
        } else if (iRltime == -1) {
            imSortingTime.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_));
        } else if (iRltime == 1) {
            imSortingTime.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_x));
        }

        if (iRlmarket == 0) {
            imSortingMarket.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_s));
        } else if (iRlmarket == -1) {
            imSortingMarket.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_));
        } else if (iRlmarket == 1) {
            imSortingMarket.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_x));
        }

        if (iRlcount == 0) {
            imSortingCount.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_s));
        } else if (iRlcount == -1) {
            imSortingCount.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_));
        } else if (iRlcount == 1) {
            imSortingCount.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.arrows_select_x));
        }
    }
