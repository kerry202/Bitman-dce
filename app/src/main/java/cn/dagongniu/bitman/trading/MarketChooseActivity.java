...
import cn.dagongniu.bitman.trading.fragment.TradingAllMarketFragmnet;
import cn.dagongniu.bitman.trading.fragment.TradingZXMarketFragmnet;
...
public class MarketChooseActivity extends BaseActivity implements View.OnClickListener, IndexPageView {
    ...
    public void setIndexPageData(IndexPageBean allMaketList) {
        ...
        Logs.s("  allMaketListallMaketList       " + allMaketList.getData().getAllMaketList().size());
        //遍历各个市场
