...
import cn.dagongniu.bitman.bitmanviews.CircleProgressView;
...
public class BitmanThorwsFragment extends BaseFragment {
    ...
    private ArrayList<StarBean> pagerlist = new ArrayList<>();
    ...
    private void getStarAdd() {
        ...
        HttpUtils.getInstance().bitmanDate(Http.startAdd, hashMap, getActivity(), new OnBaseDataListener<String>() {
            @Override
    ...
    private void getThorwPrice() {
        ...
        HttpUtils.getInstance().bitmanDate(Http.getMining, hashMap, getActivity(), new OnBaseDataListener<String>() {
            @Override
            public void onNewData(String data) {
