...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private BGABanner.AutoPlayTask mAutoPlayTask;
    ...
    private BGABanner.GuideDelegate mGuideDelegate;
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mAutoPlayTask = new BGABanner.AutoPlayTask(this);
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.banner_image, models, tips);
    }
     ...
     */
    public void setEnterSkipViewIdAndDelegate(int enterResId, int skipResId, BGABanner.GuideDelegate guideDelegate) {
    ...
    public void setDelegate(BGABanner.Delegate delegate) {
        mDelegate = delegate;
    }

    public void setAdapter(BGABanner.Adapter adapter) {
        mAdapter = adapter;
    }
