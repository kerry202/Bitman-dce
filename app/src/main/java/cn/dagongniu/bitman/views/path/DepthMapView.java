package cn.dagongniu.bitman.views.path;
...
//                invalidate();
    ...
    private void drawText(Canvas canvas) {
        ...
        for (int j = 0; j < mLineCount; j++) {
            ...
            Logs.s("   drawText value    "+value);
            Logs.s("   drawText value    "+str);
        ...
        if (size > 0 && mBottomPrice[0] != null) {
            String data = "";
            try {
//                data = getValue(mBottomPrice[0]);
//                Logs.s("   drawText 1 " + data);
...
//                drawSelectorView(canvas, mLastPosition);
    ...
    private void drawSelectorView(Canvas canvas, int position) {
        ...
        Logs.s("   drawText value 11   "+getVolumeValue(mMapX.get(position).getVolume()));
...
//        return subZeroAndDot(value);
        Logs.s("  getValuegetValue   1   " + mPriceLimit);
        Logs.s("  getValuegetValue   2    " + value);
        Logs.s("  getValuegetValue   3    " + String.format("%." + mPriceLimit + "f", value));
    ...
    private String getVolumeValue(float value) {
        ...
        Logs.s("   drawText getVolumeValue 11   "+String.format("%.4f", value));
        Logs.s("   drawText getVolumeValue 22   "+value);
