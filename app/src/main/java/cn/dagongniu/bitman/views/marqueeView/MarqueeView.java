package cn.dagongniu.bitman.views.marqueeView;
...
public class MarqueeView extends ViewFlipper {
    ...
    private int textColor = OAXApplication.getContext().getResources().getColor(R.color.text_str);
        ...
        if (getInAnimation() != null) {
            getInAnimation().setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    TextView textView = createTextView(notices.get(position));
    ...
    private TextView createTextView(String text) {
        ...
        textView.setTextColor(getResources().getColor(R.color.text_str));
        Logs.s("    onAnimationEnd createTextView    " + text);
